...
sealed interface Ast {
    ...
    sealed interface Statement : Ast {
        ...
        //    Statement
        data class While(val condition: Expression, val block: Block, override val position: SourcePosition) :
            Statement
        ...
        //data class Function(val name: String, val parameters: List<Parameter>, val returnType: Type?, val body: Statement, override val position: SourcePosition, val environment: Environment) :
        //    Statement
    }
    ...
    data class Program(val statements: List<Statement>, override val position: SourcePosition, val environment: Environment = Environment()) : Ast
    data class Block(val statements: List<Statement>, override val position: SourcePosition, val environment: Environment) : Ast
